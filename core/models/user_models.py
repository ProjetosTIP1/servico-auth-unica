...
class UserType(BaseModel):
    ...
    manager: Optional[bool] = Field(default=False, description="The name of the user's manager or supervisor")
    ...
    created_at: datetime = Field(default=..., description="The time when the user account was created")
    updated_at: datetime = Field(default=..., description="The time when the user account was last updated")
...
class UserInDBType(UserType):
    hashed_password: str = Field(default=..., description="The hashed password of the user account")

class UserUpdatePasswordType(BaseModel):
    user_id: int = Field(default=..., description="The unique identifier of the user")
    current_password: str = Field(default=..., description="The current password of the user")
    new_password: str = Field(default=..., description="The new password for the user account")
